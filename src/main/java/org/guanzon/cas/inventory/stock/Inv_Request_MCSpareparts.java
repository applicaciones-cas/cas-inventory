 ...
 * @author Unclejo
 */
public class Inv_Request_MCSpareparts implements RequestController {
    ...
    public Inv_Request_MCSpareparts(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
...
//                loModel.setRecordStatus(psTranStatus);
                ...
                lsSQL = MiscUtil.addCondition(lsSQL, "a.sCategCd2 = '0007'");
...
//                + SQLUtil.toSQL(fsValue + "%") + " AND " + lsCondition + " AND f.sCategCd1 = '0001' AND f.sCategCd2 != '0007' GROUP BY a.sTransNox ASC");
    ...
    public JSONObject loadAllInventoryMinimumLevel(){
        ...
        try {
            ...
            lsSQL = MiscUtil.addCondition(lsSQL, "a.sBranchCd = '" + poGRider.getBranchCode() + "' AND  a.nQtyOnHnd <= a.nMinLevel AND  b.sCategCd1 = '0001' AND b.sCategCd2 = '0007' ");
            ResultSet loRS = poGRider.executeQuery(lsSQL);

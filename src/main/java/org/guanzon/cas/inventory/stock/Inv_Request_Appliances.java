 ...
 * @author Unclejo
 */
public class Inv_Request_Appliances implements RequestController {
    ...
    public Inv_Request_Appliances(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
...
//                loModel.setRecordStatus(psTranStatus);
                ...
                lsSQL = MiscUtil.addCondition(lsSQL, "a.sCategCd2 = '0009'");
...
//        AddModelDetail();
    ...
    public JSONObject searchTransaction(String fsCol, String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(getSQL(), " a.sTransNox LIKE "
                + SQLUtil.toSQL(fsValue + "%") + " AND f.sCategCd1 = '0002' AND f.sCategCd2 = '0009' AND " + 
...
//                + SQLUtil.toSQL(fsValue + "%") + " AND " + lsCondition + " AND f.sCategCd1 = '0001' AND f.sCategCd2 != '0007' GROUP BY a.sTransNox ASC");
    ...
    public JSONObject loadAllInventoryMinimumLevel(){
        ...
        System.out.println("nandito ako");
        poJSON = new JSONObject();
        try {
            String lsSQL = getSQL_Detail();
            lsSQL = MiscUtil.addCondition(lsSQL, "a.sBranchCd = '" + poGRider.getBranchCode() + "' AND  a.nQtyOnHnd <= a.nMinLevel AND  b.sCategCd1 = '0002' AND b.sCategCd2 = '0009' ");

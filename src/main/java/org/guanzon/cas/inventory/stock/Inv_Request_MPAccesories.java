 ...
 * @author Unclejo
 */
public class Inv_Request_MPAccesories implements RequestController {
    ...
    public Inv_Request_MPAccesories(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
...
//                loModel.setRecordStatus(psTranStatus);
                ...
                lsSQL = MiscUtil.addCondition(lsSQL, "a.sCategCd3 = '0002'");
...
//        AddModelDetail();
    ...
    public JSONObject searchTransaction(String fsCol, String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(getSQL(), " a.sTransNox LIKE "
                + SQLUtil.toSQL(fsValue + "%") + " AND f.sCategCd1 = '0002' AND f.sCategCd2 = '0008' AND f.sCategCd3 = '0002' AND " + 
...
//                + SQLUtil.toSQL(fsValue + "%") + " AND " + lsCondition + " AND f.sCategCd1 = '0001' AND f.sCategCd2 != '0007' GROUP BY a.sTransNox ASC");
    ...
    public JSONObject loadAllInventoryMinimumLevel(){
        ...
        try {
            ...
            lsSQL = MiscUtil.addCondition(lsSQL, "a.sBranchCd = '" + poGRider.getBranchCode() + "' AND  a.nQtyOnHnd <= a.nMinLevel AND  b.sCategCd1 = '0002' AND b.sCategCd2 = '0008' and  b.sCategCd3 = '0002'");
            ResultSet loRS = poGRider.executeQuery(lsSQL);
